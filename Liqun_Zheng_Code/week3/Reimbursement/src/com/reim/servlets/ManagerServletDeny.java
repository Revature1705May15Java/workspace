...
public class ManagerServletDeny extends HttpServlet {
...
//		request.getRequestDispatcher("/employeeHome.ftl").forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int id = Integer.parseInt(request.getParameter("denyId"));
		String note = request.getParameter("noteDeny");
		...
		Service service = new Service();
 		...
 		req = service.denyReq(emp, id, note);
