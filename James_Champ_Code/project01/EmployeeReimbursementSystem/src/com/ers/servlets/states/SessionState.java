package com.ers.servlets.states;

public class SessionState {
	public static final String VIEW_PENDING = "pending";
	public static final String VIEW_RESOLVED = "resolved";
	...
	public static final String VIEW_EMPLOYEES_REQUESTS = "viewEmployeesRequests";
