 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://hotel.ex.com/", wsdlLocation = "http://localhost:8081/hotel/HelloWorld?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://hotel.ex.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/hotel/HelloWorld?WSDL");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://hotel.ex.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://hotel.ex.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
