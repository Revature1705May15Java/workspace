 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://helloservice.ex.com/", wsdlLocation = "http://localhost:8081/helloservice/HelloWorld?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/helloservice/HelloWorld?WSDL");
