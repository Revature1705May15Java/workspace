        ...
        <div class="collapse navbar-collapse" id="navbarExample">
            <ul class="sidebar-nav navbar-nav" >
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#"><i class="fa fa-users"></i> Employees</a>
                </li>
                <li class="nav-item">
            ...
            <ul class="navbar-nav ml-auto">
                <li><a class="navbar-brand pull-right" style="color:white">Welcome Arthur</a></li>
    ...
    <div class="content-wrapper py-3">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="sort">Manager Dashboard</a></li>
                <li class="breadcrumb-item active">Employee List</li>
            </ol>

			<button type="button" class="btn btn-primary pull-left" data-toggle="modal" data-target="#newUser">Add New Employee</button>
            ...
            <div class="card mb-3">
                ...
                <div class="card-block">
                    <div class="table-responsive">
                        <table id="employeesTable" class="table table-bordered tablesorter table-hover results" width="100%" id="dataTable" cellspacing="0">
                            <thead>
                                <tr class="filters">
                                	<th>Employee Id</th> 
                                    <th>Name</th>
                            ...
                            <#list users as user>
                                <tr>
                                    <th>${user.id}</th>
                                    <th class="name">${user.fn} ${user.ln}</th>
                                    <th class="email">${user.em}</th>
                                    <#if user.isBoss == 1>
                                    <th class="manager">Manager</th>
                                    <#elseif user.isBoss == 0>
                                    <th class="manager">Employee</th>
                                    </#if>
                                </tr>
                             </#list> 
                            </tbody>
            ...
            <div class="card mb-3">
                ...
                <div class="card-block">
                    <div class="table-responsive">
                        <table id="pendingRequestsTable" class="table table-bordered tablesorter table-hover" width="100%" id="dataTable" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>Request Id</th>
                                    <th>State</th>
                            ...
                            <#list requests as request>
                                <tr>
                                    <th class="id">${request.id} </th>
                                    <#if request.stateId == 1>
                                    <th class="state">Pending</th>
									<#elseif request.stateId == 2>
									<th class="state">Approved </th>
									<#elseif request.stateId == 3>
									<th class="state">Denied </th>
									</#if>
                                    <th class="dateRequested">${request.reqDate} </th>
                                    <#if request.resDate??>
                                    <th class="dateResolved">${request.resDate} </th>
                                    <#else>
                                    <th class="dateResolved">N/A </th>
                                    </#if>
                                    <th class="amount">${request.amount} </th>
                                    <th class="reqName">${request.reqFn} ${request.reqLn}</th>
							            ...
							            <div class="modal-content">
							                ...
							                <div class="modal-footer">
												...
												<form action="sort" method="post">
													...
													<button id="accept${request.id}" class="btn btn-success" name="reqState" type="submit" value="2">Approve</button>
													
													<button id="deny${request.id}" class="btn btn-danger" name="reqState" type="submit" value="3">Deny</button>
												</form>
												<script>
