...
//			System.out.println("I can't access instance methods: " + instanceVar);
	...
	class MemberInner {
		String instanceData = "MemberInner: member inner data"; // this is called shadowing
		// inner class's instance variable shadows the outer class's instance variable of the same name
