...
public class IoDAO implements DAO {
   ...
   * containing them (This method should only be used in the constructor to
   * initialize the students list)
   * 
   * @return an ArrayList of all the Student objects contained in the file when
   *         reading the file is successful, or an empty ArrayList if
   *         serializer.readStudentsList() returns null
   */
  ...
  public ArrayList<Student> getAllStudents() {
    // if the students instance variable always matches the students in
    // data.txt, this should be fine
