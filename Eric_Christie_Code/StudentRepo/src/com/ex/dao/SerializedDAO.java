...
public class SerializedDAO implements DAO {
  ...
  public Student updateStudent(int id, Student updated) throws StudentNotFoundException {
    // might be better to avoid using other methods from this class since most
    // of them read the entire file
  ...
  /**
   * read in all the Student objects from the file and returns an ArrayList
   * containing them
   * 
   * @return an ArrayList of all the Student objects contained in the file when
   *         reading the file is successful, null otherwise
   */
  ...
  /**
   * check if the students instance variable contains all the Student objects
   * from the file
   * 
   * @return true if all Student objects from the file are in the list of
  ...
  /**
   * check if the students instance variable contains all the Student objects
   * from the file in the same order as they are in the file
   * 
   * @return true if the list of students contains all the Student objects from
   *         the file in the correct order, false otherwise
   */
