 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://helloservice.ex.com/", wsdlLocation = "http://192.168.61.7:8081/helloservice/HelloWorld?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://helloservice.ex.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.61.7:8081/helloservice/HelloWorld?WSDL");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://helloservice.ex.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://helloservice.ex.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
