 ...
 */
public abstract class SuperDuperClass {
	abstract boolean checkUpper(String test);
	abstract String toUpperCase(String test);
	abstract void convertIntPlusTen(String test);
}
