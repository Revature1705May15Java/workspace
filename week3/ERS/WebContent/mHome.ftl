...
<div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <ul class="nav nav-pills nav-stacked admin-menu" >
                    <li class="active"><a href="" data-target-id="profile"> Profile</a></li>
                    <li><a href="" data-target-id="update"> Update Information</a></li>
                    <li><a href="" data-target-id="requests"> View Closed Requests</a></li>
                    <li><a href = ""data-target-id="OpenReq">View Open Requests</a></li>
                    <li><a href="" data-target-id="logout"> Logout</a></li>
   ...
   <div class="col-md-9  admin-content" id="requests">
                <div class="panel panel-info" style="margin: 1em;">
                    <div class="panel-heading">
     ...
     <div class="col-md-9  admin-content" id="OpenReq">
                <div class="panel panel-info" style="margin: 1em;">
                    <div class="panel-heading">
            ...
            <div class="col-md-9  admin-content" id="update">
