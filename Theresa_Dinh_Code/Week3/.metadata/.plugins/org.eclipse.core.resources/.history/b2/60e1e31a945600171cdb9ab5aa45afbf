...
/**
 * Servlet implementation class TableApproveServlet
 */
@WebServlet({ "/TableApproveServlet", "/approve" })
public class TableApproveServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public TableApproveServlet()     
    {
        super();
    }
