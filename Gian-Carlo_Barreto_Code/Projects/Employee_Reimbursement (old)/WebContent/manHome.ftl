...
<body>
	<div class="page-header">
		 <h1> Welcome ${firstname} ${lastname} to the Manager Homepage</h1>
	...
	<ul class="nav nav-pills">
	  ...
	  <li role="presentation" class="dropdown">
	    ...
	    <ul class="dropdown-menu">
	      <li role="presentation"><a href="allResView">View All</a></li>
	      <li role="presentation"><a href="#">View Pending</a><li>
	      <li role="presentation"><a href="resView">View Resolved</a><li>
	    </ul>
	  </li>
	...
	<div class="row">
		<div class="col-xs-6 col-md-4">
			<a href="#" class="thumbnail">
				<h4>View Pending Request</h4>
			</a>
		</div>
		
		<div class="col-xs-6 col-md-4">
			<a href="resView" class="thumbnail">
				<h4>View Resolved Requests</h4>
			</a>
		</div>
		
		<div class="col-xs-6 col-md-4">
			<a href="empsView" class="thumbnail">
